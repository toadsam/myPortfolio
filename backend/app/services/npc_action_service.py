...
ACTION_DEFINITIONS: dict[str, list[dict[str, Any]]] = {
    ...
    "project-npc": [
        ...
        },
        {
            ...
            "keywords": ["mywave", "festflow", "건물", "상세"],
