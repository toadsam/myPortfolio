...
export const npcActions: NpcActionDefinition[] = [
  ...
  },
  {
    ...
    triggerKeywords: ["대표", "추천", "프로젝트", "best"],
  ...
  },
  {
    ...
    triggerKeywords: ["MyWave", "FestFlow", "건물", "상세"],
  ...
  },
  {
    ...
    npcId: "developer-npc",
    label: "아키텍처 보드 준비",
    description: "서비스 구조와 데이터 흐름을 설명할 준비를 합니다.",
    triggerKeywords: ["구조", "흐름", "백엔드", "API"],
  ...
  },
  {
    ...
    triggerKeywords: ["연락", "메일", "문의", "contact"],
  ...
  },
  {
    ...
    triggerKeywords: ["GitHub", "깃허브", "코드", "링크"],
