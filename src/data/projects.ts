...
export const projects: ProjectData[] = [
  ...
  },
  {
    ...
    title: "MyStock-Desk",
    description:
      "거래 기록 기반 포트폴리오 분석과 AI 체크리스트를 제공하는 투자 기록 서비스입니다.",
  ...
  },
  {
    ...
    tech: ["Spring Boot", "Firebase", "React", "TypeScript", "3D Avatar"],
    features: [
      "수어 퀴즈 학습",
      "텍스트를 수어 아바타로 변환",
      "반복 학습 흐름",
    ...
    learning:
      "3D 아바타 애니메이션과 백엔드 API가 연결되는 서비스 구조를 경험했습니다.",
    problem:
  ...
  },
  {
    ...
    title: "아주대모험",
    description:
      "아주대학교 캠퍼스를 배경으로 한 Phaser 3 기반 2D 캐주얼 게임입니다.",
    role: "게임 기획 및 전체 개발",
