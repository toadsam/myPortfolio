...
function SectionOverview({
  ...
  return (
    <div className="flex h-full flex-col justify-center gap-7 py-4">
      ...
      >
        <p className="mb-2 font-mono text-xs font-black uppercase tracking-[0.2em] text-white/30">
          담당 역할
        </p>
  ...
  return (
    <div className="flex h-full flex-col justify-center gap-8 py-4">
      ...
      <motion.div
        ...
        whileHover={{x: 4}}
      >
        <span className="mt-0.5 font-mono text-lg" style={{color}}>
          💡
        </span>
        <div>
          <p className="mb-1 font-mono text-xs font-black uppercase tracking-[0.18em] text-white/30">
            배운 점
          </p>
    ...
    <div className="flex h-full flex-col justify-center gap-6 py-4">
      ...
      <div className="relative ml-4 flex flex-col gap-0">
        ...
        <motion.div
          ...
          style={{
            background: `linear-gradient(to bottom, ${color}, ${color}22)`,
            originY: 0
          }}
          ...
          {project.tech.map((t, i) => (
            ...
            >
              <div
                ...
                style={{background: techColors[i % techColors.length]}}
              />
              <span
                className="font-mono text-sm font-black"
                style={{color: techColors[i % techColors.length]}}
              >
                {t}
              </span>
            </motion.div>
  ...
  return (
    <div className="flex h-full flex-col justify-center gap-7 py-4">
      ...
      >
        ...
        />
        <p className="relative z-10 text-lg leading-8 text-white/90">
          {project.result}
        </p>
      </motion.div>
...
export function ProjectViewer({project, onClose}: Props) {
  ...
  if (project && projectTheme) {
    ...
    if (cat === "game")
      viewer = <GameProjectViewer key={project.id} {...shared} />;
    else if (cat === "dashboard")
      viewer = <DashboardProjectViewer key={project.id} {...shared} />;
    else if (cat === "realtime")
      viewer = <RealtimeProjectViewer key={project.id} {...shared} />;
    else if (cat === "platform")
      viewer = <PlatformProjectViewer key={project.id} {...shared} />;
    if (viewer) {
      return (
        <AnimatePresence>
          {viewer}
      ...
      {project ? (
        ...
        >
          ...
          <div
            ...
            style={{
              background:
                "radial-gradient(ellipse at 25% 35%, #0d1e3a 0%, #040608 65%)"
            }}
          />
          ...
          <div className="relative z-10 flex h-full w-full">
            ...
            >
              ...
              <div className="mb-6">
                <p
                  className="mb-1 font-mono text-[10px] font-black uppercase tracking-[0.22em]"
                  style={{color}}
                >
                  {">"} Project
                </p>
              ...
              <div className="mb-6">
                <p className="mb-2.5 font-mono text-[10px] font-black uppercase tracking-[0.18em] text-white/25">
                  Tech Stack
                </p>
              ...
              <nav className="mb-6 flex flex-1 flex-col gap-1">
                <p className="mb-2 font-mono text-[10px] font-black uppercase tracking-[0.18em] text-white/25">
                  Navigation
                </p>
                {STEPS.map((step, i) => {
            ...
            >
              ...
              <div className="relative flex-1 overflow-hidden">
                <AnimatePresence custom={direction} mode="wait">
                  ...
                  >
                    {currentStep === 0 && (
                      <SectionOverview project={project} color={color} />
                    )}
                    {currentStep === 1 && (
                      <SectionProblem project={project} color={color} />
                    )}
                    {currentStep === 2 && (
                      <SectionApproach project={project} color={color} />
                    )}
                    {currentStep === 3 && (
                      <SectionContribution project={project} color={color} />
                    )}
                    {currentStep === 4 && (
                      <SectionResult project={project} color={color} />
                    )}
                  </motion.div>
                </AnimatePresence>
              </div>
                  ...
                  {STEPS.map((_, i) => (
                    <button
                      ...
                      style={{
                        ...
                        boxShadow:
                          i === currentStep ? `0 0 8px ${color}` : "none"
                      }}
                      type="button"
                    />
                  ))}
