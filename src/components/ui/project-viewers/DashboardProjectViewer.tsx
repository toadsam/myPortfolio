...
function Sparkline({
  ...
  const points = Array.from({length: 24}, (_, i) => {
    ...
    const noise =
      Math.sin(i * 1.7 + seed) * 0.18 + Math.sin(i * 0.6 + seed) * 0.12;
  ...
  return (
    <motion.div
      ...
      whileHover={{
        ...
        boxShadow: `0 0 24px ${theme.primary}12`
      }}
    >
      {title ? (
        <div
  ...
  return (
    <motion.div
      ...
      style={{
        ...
        backgroundImage: `radial-gradient(ellipse at 20% 0%, ${theme.primary}10, ${theme.bg} 60%)`
      }}
      initial={{opacity: 0}}
      animate={{opacity: 1}}
      exit={{opacity: 0}}
