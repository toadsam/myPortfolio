  ...
  if (step === 0) {
    return (
      <div className="flex h-full flex-col gap-5 py-2">
        ...
        <div
          className="flex flex-wrap items-center gap-6 rounded-xl border p-5"
          style={{borderColor: `${theme.primary}22`}}
        >
          <Gauge value={98} label="Uptime" color={theme.primary} delay={0.2} />
          <Gauge
            value={Math.min(project.features.length * 18, 100)}
            label="Coverage"
            color={theme.accent}
            delay={0.35}
          />
          ...
          <div className="flex-1">
            <p className="mb-2 font-mono text-[10px] font-black uppercase tracking-[0.2em] text-white/35">
              ROLE
            </p>
    ...
    return (
      <div className="flex h-full flex-col justify-center gap-5 py-2">
        <div
          ...
          style={{borderColor: theme.primary, background: `${theme.primary}0a`}}
        >
          <p
            className="mb-2 flex items-center gap-2 font-mono text-xs font-black uppercase tracking-[0.2em]"
            style={{color: theme.primary}}
          >
            ALERT - 무엇이 문제였나
          </p>
        ...
        <div
          ...
          style={{borderColor: `${theme.primary}22`}}
        >
          <p className="mb-1 font-mono text-[10px] font-black uppercase tracking-[0.2em] text-white/35">
            INSIGHT - 배운 점
          </p>
      ...
      <div className="flex h-full flex-col justify-center gap-0 py-2">
        {project.approach.map((item, index) => (
          ...
          >
            ...
            >
              <span
                className="font-mono text-[10px] font-black uppercase tracking-[0.15em]"
                style={{color: theme.primary}}
              >
                STAGE {index + 1}
              </span>
  ...
  if (step === 3) {
    return (
      <div className="flex h-full flex-col justify-center gap-5 py-2">
        <div>
          <p
            className="mb-3 font-mono text-xs font-black uppercase tracking-[0.25em]"
            style={{color: theme.primary}}
          >
  ...
  return (
    <div className="flex h-full flex-col justify-center gap-5 py-2">
      ...
      >
        ...
        />
        <p
          className="relative mb-2 flex items-center gap-2 font-mono text-xs font-black uppercase tracking-[0.2em]"
          style={{color: theme.primary}}
        >
          <LiveDot color={theme.primary} /> STATUS - 결과
        </p>
        <p className="relative text-base leading-8 text-white/90">
          {project.result}
        </p>
      </div>
      <div
  ...
  return (
    <motion.div
      ...
      style={{
        ...
        backgroundImage: `radial-gradient(ellipse at 80% 0%, ${theme.primary}12, ${theme.bg} 60%)`
      }}
      initial={{opacity: 0}}
      animate={{opacity: 1}}
      exit={{opacity: 0}}
