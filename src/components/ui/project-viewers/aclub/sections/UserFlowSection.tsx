...
const SCREENS: Record<
  ScreenId,
  {title: string; step: string; path: string; lines: number[]}
> = {
  "scr-1": {
    title: "동아리 둘러보기",
    step: "1 / 4",
...
const ROUTE_LINES: {no: number; body: ReactNode}[] = [
  ...
  },
  {
    ...
    body: (
      <>
        {"  "}&lt;<Kwd>Route</Kwd> path=<Strn>&quot;/clubs&quot;</Strn> element=
        {"{"}&lt;<Kwd>List</Kwd>/&gt;{"}"} /&gt;
      </>
    )
  },
  {
    ...
    body: (
      <>
        {"  "}&lt;<Kwd>Route</Kwd> path=<Strn>&quot;/clubs/:id&quot;</Strn>{" "}
        element={"{"}&lt;<Kwd>Detail</Kwd>/&gt;{"}"} /&gt;
      </>
    )
  },
  {
    ...
    body: (
      <>
        {"  "}&lt;<Kwd>Route</Kwd> path=
        <Strn>&quot;/clubs/:id/recruit&quot;</Strn> element={"{"}&lt;
        <Kwd>Recruit</Kwd>/&gt;
        {"}"} /&gt;
      </>
    )
  },
  {
    ...
    body: (
      <>
        {"  "}&lt;<Kwd>Route</Kwd> path=
        <Strn>&quot;/clubs/:id/apply&quot;</Strn> element={"{"}
      </>
    )
  },
  {
  ...
  },
  {
    ...
    body: (
      <>
        {"  "}&lt;<Kwd>Route</Kwd> path=<Strn>&quot;/login&quot;</Strn> element=
        {"{"}&lt;<Kwd>Login</Kwd>/&gt;{"}"} /&gt;
      </>
    )
  },
    ...
    >
      <div className="mx-auto flex max-w-[1140px] flex-col px-6 py-[120px]">
        <header className="mb-12">
          ...
          >
            둘러보고, 마음에 드는 걸 열어보고, 모집 공고를 확인하고, 지원한다.
            네 단계 중 어디서든 나갔다가 다시 들어올 수 있어야 했다. 아래에서{" "}
            ...
            >
              ...
              <div className="absolute left-0 top-0 z-[50] flex h-[34px] w-full items-center border-b border-white/5 bg-[#0f0a1a]/90 px-4 pt-2 backdrop-blur-sm">
                <button
                  ...
                  style={{
                    opacity: stack.length > 1 ? 1 : 0,
                    pointerEvents: stack.length > 1 ? "auto" : "none"
                  }}
                >
                  <svg
                    width="14"
              ...
              <div className="isolate relative h-full w-full overflow-hidden bg-[#0d0816] pt-[34px]">
                ...
                <ScreenBox
                  id="scr-1"
                  style={screenStyle("scr-1")}
                  className="ac-no-scrollbar overflow-y-auto p-4 pb-8"
                >
                    ...
                    {MOCK_CLUBS.map((c, i) => {
                      ...
                      return (
                        <button
                          ...
                          type="button"
                          onClick={
                            isFirst ? () => navigate("scr-2") : undefined
                          }
                        ...
                        >
                          ...
                          <span className="truncate text-[13px] font-bold text-[rgba(255,255,255,0.88)]">
                            {c.name}
                          </span>
                        </button>
                      );
                ...
                <ScreenBox
                  id="scr-2"
                  style={screenStyle("scr-2")}
                  className="ac-no-scrollbar overflow-y-auto"
                >
                  <div className="relative flex aspect-[16/9] w-full items-center justify-center bg-[#170f26]">
                    ...
                    <span className="font-mono text-xs text-[rgba(255,255,255,0.46)]">
                      [IMG-SLOT]
                    </span>
                  </div>
                  <div className="flex flex-col gap-4 p-5">
                    <div>
                      <h1 className="mb-1 text-xl font-black text-[rgba(255,255,255,0.88)]">
                        빛그림 사진회
                      </h1>
                      <p className="text-sm leading-relaxed text-[rgba(255,255,255,0.46)]">
                        카메라 렌즈 너머로 세상을 바라보고, 찰나의 순간을
                        영원으로 기록하는 사람들의 모임입니다. 필름부터
                        디지털까지 장비 무관.
                      </p>
                    </div>
                      ...
                      {[
                        ...
                        <div key={k} className="flex flex-col gap-3">
                          ...
                          <div className="flex justify-between">
                            ...
                            <span className="font-medium tabular-nums text-[rgba(255,255,255,0.88)]">
                              {v}
                            </span>
                          </div>
                        </div>
                ...
                >
                  ...
                  <div className="flex flex-col gap-6 p-5 pb-24">
                    <div>
                      <h2 className="mb-3 text-[15px] font-bold text-[rgba(255,255,255,0.88)]">
                        지원 자격
                      </h2>
                    ...
                    <div>
                      ...
                      <div className="relative space-y-4 border-l border-white/10 pl-4 text-[13px]">
                        <div className="relative">
                          ...
                          <p className="font-bold text-[rgba(255,255,255,0.88)]">
                            서류 접수
                          </p>
                          <p className="mt-0.5 text-[12px] tabular-nums text-[rgba(255,255,255,0.46)]">
                            3/4(월) ~ 3/18(월)
                          </p>
                        </div>
                        <div className="relative">
                          <span className="absolute -left-[21px] top-1.5 h-2.5 w-2.5 rounded-full border-2 border-[#0d0816] bg-white/20" />
                          <p className="font-bold text-[rgba(255,255,255,0.46)]">
                            대면 면접
                          </p>
                          <p className="mt-0.5 text-[12px] tabular-nums text-[rgba(255,255,255,0.28)]">
                            3/20(수) ~ 3/21(목)
                          </p>
                        </div>
                      </div>
                ...
                >
                  ...
                  >
                    <div className="mb-2 rounded-lg border border-white/5 bg-[#170f26] p-4">
                      <h4 className="mb-1 text-sm font-bold text-[rgba(255,255,255,0.88)]">
                        빛그림 사진회 지원서
                      </h4>
                      <p className="text-[12px] text-[#fbbf24]">
                        이 양식은 시연용으로, 실제 데이터가 전송되지 않습니다.
                      </p>
                    </div>
                    <label className="flex flex-col gap-1.5">
                      <span className="ml-1 text-[13px] font-bold text-[rgba(255,255,255,0.88)]">
                        지원 동기
                      </span>
                      <textarea
                ...
                >
                  <div className="mb-8 text-center">
                    ...
                    <h1 className="mb-2 text-xl font-black text-[rgba(255,255,255,0.88)]">
                      로그인이 필요합니다
                    </h1>
          ...
          <section className="mt-8 flex w-full flex-col gap-5 sm:flex-row lg:mt-0 lg:w-[48%] lg:flex-col lg:gap-6 lg:pt-10">
            ...
            >
              <div className="relative h-[244px] w-[320px] shrink-0">
                ...
                >
                  ...
                  <path
                    d="M75,44 L75,60 M75,104 L75,120 M75,164 L75,180"
                ...
                {(Object.keys(NODES) as ScreenId[]).map(id => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {id === "scr-login" ? (
                        <span className="absolute -top-[24px] font-mono text-[9px] text-[#4ade80]">
                          원위치 복귀
                        </span>
                      ) : null}
                    </div>
            ...
            >
              <div className="flex h-8 shrink-0 items-center gap-2 border-b border-[rgba(192,132,252,0.18)] bg-[#170f26]/30 px-4">
                ...
                <span className="ml-2 font-mono text-[11px] text-[rgba(255,255,255,0.46)]">
                  routes.tsx
                </span>
              </div>
              <div className="ac-scroll-thin relative flex-1 overflow-x-auto overflow-y-hidden py-2 font-mono text-[11px] leading-relaxed sm:text-[12px]">
                {ROUTE_LINES.map(line => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <span className="text-[rgba(255,255,255,0.88)]">
                        {line.body}
                      </span>
                    </div>
                  );
                ...
                <div className="mt-2 whitespace-nowrap px-4">
                  <span
                    className="text-[10px] opacity-80 sm:text-[11px]"
                    style={{color: "#7a5f8a"}}
                  >
                    {
        ...
        <Reveal className="mt-[44px] max-w-3xl rounded-md border border-[rgba(192,132,252,0.18)] border-l-[3px] border-l-[#c084fc] bg-[rgba(192,132,252,0.04)] p-[22px]">
          ...
          <p className="text-[15px] leading-8 text-[rgba(255,255,255,0.88)]">
            ...
            링크로 보낼 수도 없고, 뒤로가기로 닫을 수도 없고, 새로고침하면
            사라진다. 앞 장에서 겪은 문제가 여기서도 똑같이 나온다는 걸 알고
            전부 라우트로 바꿨다.
          </p>
        </Reveal>
          ...
          {[
            ...
            <figure key={f.slot} className="flex flex-1 flex-col">
              <div className="ac-dot-grid flex w-full items-center justify-center overflow-hidden rounded-md border border-[rgba(192,132,252,0.18)] bg-[#0f0a1a] shadow-sm max-md:aspect-video md:aspect-[9/16]">
                <span className="font-mono text-[12px] tracking-widest text-[rgba(255,255,255,0.46)]">
                  {f.slot}
                </span>
              </div>
              <figcaption className="mt-3 text-center text-[13px] text-[rgba(255,255,255,0.46)]">
                {f.caption}
              </figcaption>
            </figure>
          ))}
