...
export function ResultSection() {
  const {rootRef, lightsOn, setLightsOn, lockScroll, reducedMotion} =
    useDarkLab();
      ...
      <div className="z-10 flex w-full max-w-[1020px] flex-col items-center px-6">
        ...
        <div className="dl-fade-up mb-20 w-full">
          <div className="mb-4 flex items-center gap-3">
            <span className="font-mono text-[11px] tracking-[0.2em] text-[#ff5a4d]">
              ▶ 플레이 영상 · 전체
            </span>
          </div>
          <button
        ...
        <div className="mb-6 grid w-full grid-cols-1 gap-4 sm:grid-cols-3">
          <div className="dl-fade-up rounded-md border border-white/10 bg-[#131011] p-6">
            <div
              ref={metric1}
              className="font-mono text-[30px] font-black tabular-nums text-[#ff5a4d]"
            >
              0
            </div>
            <div className="mt-2 text-[12px] text-[rgba(255,255,255,0.42)]">
              기술 스택
            </div>
          </div>
          <div className="dl-fade-up rounded-md border border-white/10 bg-[#131011] p-6">
          ...
          <div className="dl-fade-up rounded-md border border-white/10 bg-[#131011] p-6">
            <div className="font-mono text-[30px] font-black text-[#ff5a4d]">
              프로토타입
            </div>
            <div className="mt-2 text-[12px] text-[rgba(255,255,255,0.42)]">
              완성도
