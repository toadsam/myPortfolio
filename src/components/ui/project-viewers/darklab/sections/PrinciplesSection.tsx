...
const PRINCIPLES = [
  {
    ...
    title: "시야를 제한한다",
    file: "PlayerLight.cs",
    body: "정보를 차단하는 것이 공포의 시작입니다. 빛의 감쇠를 계산하고 렌더링 파이프라인에서 시야각을 좁혀, 플레이어가 등 뒤의 존재를 확인할 수 없게 만듭니다. 손전등 반경 밖은 알 수 없다.",
  ...
  },
  {
    ...
    title: "소리를 앞세운다",
    file: "AmbientCue.cs",
    body: "눈에 보이지 않는 공포를 소리로 먼저 전달합니다. 공간 음향(Spatial Audio)과 무작위 앰비언트 트리거를 통해 아무것도 없는 어둠 속에서도 존재감을 느끼게 합니다. 소리가 먼저 오면 플레이어는 스스로 최악을 상상한다.",
    echo: "↳ 들어올 때 들린 삐걱임",
    pulse: false
  },
  {
    ...
    body: "가장 안전하다고 느끼는 순간 통제권을 박탈합니다. 강제적인 시선 유도는 플레이어의 주도권을 무력화하며 극도의 무력감을 유발하는 가장 효과적인 장치입니다.",
      ...
      <div className="z-10 w-full max-w-[820px] px-6">
        <header className="dl-fade-up mb-20">
          ...
          <div className="space-y-4 text-[15px] leading-relaxed text-[rgba(255,255,255,0.42)]">
            <p>
              공포 게임에서 기술은 공포를 구현하는 &lsquo;도구&rsquo;가 아닌,
              공포 그 자체가 되어야 합니다. 우리는 플레이어가 시스템의 논리를
              파악하지 못하게 만들어야 하며, 그 불확실성 사이에서 긴장감이
              탄생합니다.
            </p>
            <p>
              단순한 점프 스케어보다는 심리적인 압박감을 선사하기 위해 세 가지의
              프로그래밍 원칙을 지향합니다. 이 원칙들은 지금 당신이 경험하고
              있는 이 페이지에도 녹아있습니다.
            </p>
          </div>
        </header>
