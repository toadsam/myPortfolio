...
export function Trouble01Section() {
  const {rootRef, reducedMotion, lockScroll, sequencesDone, markSequenceDone} =
    useDarkLab();
  ...
  return (
    ...
    >
      ...
      <div className="z-10 w-full max-w-[900px] px-6">
        <div
          ref={triggerRef}
          className="mb-12 flex h-[300px] flex-col justify-end"
        >
        ...
        >
          <div className="mb-16 rounded-md border border-[#f87171]/30 bg-[#f87171]/[0.04] p-6">
            <div className="mb-6 flex items-start justify-between">
              <span className="font-mono text-[11px] uppercase tracking-[0.25em] text-[#f87171]">
                TROUBLE 01
              </span>
            ...
            <table className="w-full border-collapse text-left">
              ...
              <tbody>
                {SUSPECTS.map(row => (
                  ...
                  >
                    <td className={`py-4 font-mono ${row.cause ? "pl-3" : ""}`}>
                      {row.suspect}
                    </td>
                    <td className="py-4">
                      <span
                    ...
                    <td className="py-4 text-[rgba(255,255,255,0.57)]">
                      {row.reason}
                    </td>
                  </tr>
                ))}
