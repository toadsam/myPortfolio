    ...
    >
      <div className="grid gap-4 lg:grid-cols-[1.1fr_1fr]">
        ...
        <div className="flex flex-col gap-4">
          ...
          >
            <p className="font-mono text-[10px] font-black uppercase tracking-[0.18em] text-white/40">
              평가액
            </p>
            ...
            >
              {up ? "▲" : "▼"} {won(Math.abs(totalDayPnl))} ({up ? "+" : ""}
              {returnPct.toFixed(2)}%) 오늘
            </p>
            {/* 자산 비중 스택 바 */}
            <div
        ...
        <div className="flex flex-col gap-1.5">
          <p
            className="mb-1 font-mono text-[10px] font-black uppercase tracking-[0.18em]"
              ...
              <div className="min-w-0">
                <div className="flex items-center gap-2">
                  ...
                  <span
                    ...
                    style={{color: r.day >= 0 ? theme.primary : "#f87171"}}
                  >
                    {r.day >= 0 ? "+" : ""}
                    {(r.day * 100).toFixed(1)}%
                  </span>
                ...
                <span className="font-mono text-[10px] text-white/35">
                  {won(r.price)} · {r.q}주 · {won(r.value)}
                </span>
              </div>
              <div className="flex items-center gap-1">
                <motion.button
                  type="button"
                  onClick={() => trade(r.id, -1)}
                  whileTap={{scale: 0.85}}
                  className="h-7 w-7 rounded-md border font-mono text-sm font-black text-white/70"
                ...
                <motion.button
                  ...
                  onClick={() => trade(r.id, 1)}
                  whileTap={{scale: 0.85}}
                  className="h-7 w-7 rounded-md border font-mono text-sm font-black"
                  style={{
