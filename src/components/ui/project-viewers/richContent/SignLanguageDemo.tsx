  ...
  return (
    ...
    >
      <div className="grid gap-4 lg:grid-cols-[1fr_1fr]">
        {/* 아바타 무대 */}
        <div
          className="relative flex flex-col items-center justify-center overflow-hidden rounded-xl border py-6"
          style={{
            borderColor: `${theme.primary}22`,
            background:
              "radial-gradient(circle at 50% 30%, rgba(255,255,255,0.04), rgba(0,0,0,0.25) 70%)"
          }}
        >
