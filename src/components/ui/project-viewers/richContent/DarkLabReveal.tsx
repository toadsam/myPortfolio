    ...
    <DemoFrame
      ...
      footer={
        <p className="font-mono text-[11px] leading-5 text-white/45">
          🔦 마우스를 움직여 <span style={{color: theme.primary}}>어둠 속을 비춰보세요</span> — 1인칭 탐색의 긴장감을 그대로.
        </p>
      }
    >
      <div
        ...
        style={{borderColor: `${theme.primary}22`, background: "#05060a", cursor: "none"}}
        onMouseMove={(e) => {
      ...
      >
        ...
        <motion.div className="absolute inset-0" style={{WebkitMaskImage: mask, maskImage: mask}}>
          <div className="absolute inset-0" style={{background: "radial-gradient(circle at 30% 40%, #161a24, #07080d 80%)"}} />
          {/* 실험실 오브젝트들 */}
          <div className="absolute left-[12%] top-[22%] font-mono text-[13px] font-bold" style={{color: theme.accent}}>⚠ SECTOR 7 — 격리 구역</div>
          <div className="absolute left-[16%] top-[44%] h-20 w-28 rounded border" style={{borderColor: `${theme.primary}55`, background: `${theme.primary}0c`}}>
            <span className="absolute bottom-1 left-1 font-mono text-[9px] text-white/40">실험체 보관함</span>
          </div>
          <div className="absolute right-[18%] top-[30%] font-mono text-[11px] leading-5 text-white/55">
            출입 기록: 03:14 AM<br />마지막 접속자: 미상<br />상태: <span style={{color: "#f87171"}}>연결 끊김</span>
          </div>
          <div className="absolute bottom-[14%] right-[24%] text-3xl">🩸</div>
          <div className="absolute bottom-[12%] left-[40%] font-mono text-[10px] text-white/30">“여기서 나가야 해...”</div>
