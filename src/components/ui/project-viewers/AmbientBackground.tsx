...
function HudFrame({theme}: {theme: ProjectTheme}) {
  ...
  const corner = (pos: string, b: string) => (
    <div
      ...
      style={{...positionStyle(pos), borderColor: c, ...borderStyle(b)}}
    />
  );
  return (
    <>
  ...
  return (
    <>
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse at 50% 40%, transparent 30%, rgba(0,0,0,0.85) 100%)"
        }}
      />
      <motion.div
        className="absolute inset-0"
        style={{
          background: `radial-gradient(circle at 50% 45%, ${theme.primary}10, transparent 60%)`
        }}
  ...
  return (
    <>
      <motion.div
        className="absolute inset-0"
        style={{
          background: `radial-gradient(circle at 50% 60%, ${theme.primary}12, transparent 55%)`
        }}
      ...
      {rise.map((d, i) => (
        <motion.span
          ...
          animate={{y: [0, -440], opacity: [0, 0.5, 0]}}
          transition={{
            duration: d.d + 4,
            delay: d.delay,
            repeat: Infinity,
    ...
    <>
      ...
      {bits.map((b, i) => (
        <motion.span
          ...
          style={{left: `${b.x}%`, color: `${theme.primary}55`}}
      ...
      {stars.map((d, i) => (
        <motion.span
          ...
          style={{
            ...
            width: d.s,
            height: d.s,
            background: i % 3 ? "#fff" : theme.accent,
            opacity: 0.4
          }}
  ...
  return (
    <>
      ...
      <motion.div
        ...
        style={{background: `${theme.primary}10`, left: "55%", top: "55%"}}
