 ...
 *
 * (2026-09-20 보정) "많은 것은 공짜"는 **FPS 한정**이다. three 는 광원 반복문을 셰이더
 * 소스에서 펼치므로 **첫 방문 컴파일 시간은 광원 수에 비례한다** — 포인트 광원 반복을
 * 10 → 1 로 자른 실험에서 변종당 600 → 200ms 였다. 풀을 키울 때는 그 값을 같이 본다
 * (VillageScene.tsx SceneWarmup 주석 · docs/VILLAGE_OVERHAUL_REPORT.md §6-b).
 *
