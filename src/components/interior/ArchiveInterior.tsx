  ...
  return (
    ...
    >
      ...
      <mesh position={[0, 1.55, -0.06]}>
        ...
        <meshBasicMaterial
          color={hovered ? accentColor : "#a07840"}
          transparent
      ...
      >
        ...
        >
          ...
          <div style={{fontSize: 9, color: "#5e6757", lineHeight: 1.5}}>
      ...
      {bookColors.map((color, i) => {
        ...
        return (
          <mesh
            key={i}
            castShadow
            position={[-1.0 + pos * 0.72, shelf * 0.72 + 0.36, 0.05]}
          >
...
export function ArchiveInterior({onBack}: Props) {
  ...
  function handleSelect(item: ExperienceItem, pos: [number, number, number]) {
    ...
    const color =
      ACCENT_COLORS[experienceItems.indexOf(item) % ACCENT_COLORS.length] ??
      "#c8a86a";
  ...
  return (
    <div className="fixed inset-0 z-40 bg-[#1e1408]">
      ...
      <motion.div
        {...uiDelay(-1)}
        className="pointer-events-none fixed left-1/2 top-4 z-50 -translate-x-1/2 rounded-xl border border-[#c8a86a]/40 bg-[#1e1408]/80 px-5 py-2 text-xs font-black uppercase tracking-[0.22em] text-[#c8a86a] backdrop-blur-md"
      ...
      <motion.div
        {...uiDelay(1)}
        className="pointer-events-none fixed bottom-5 left-1/2 z-50 flex -translate-x-1/2 items-center gap-2 rounded-xl border border-[#c8a86a]/40 bg-[#1e1408]/80 px-4 py-2.5 backdrop-blur-md"
        ...
        {selectedItem ? (
          ...
          >
            ...
            >
              ...
              >
                <p className="text-xs font-black uppercase tracking-[0.2em] text-[#c8a86a]">
                  {selectedItem.year}
                </p>
                <h2 className="mt-2 text-2xl font-black text-[#f0e0c0]">
                  {selectedItem.title}
                </h2>
                <p className="mt-4 text-sm leading-7 text-[#c8a86a]">
