...
const heroCopy = {
  ...
  body:
    "A living portfolio shaped like a tree: roots for identity, branches for skills, fruits for projects, rings for growth, and seeds for the next collaboration."
};
...
const skills = [
  {
    ...
    name: "React",
    group: "Frontend",
    description: "Component-driven interfaces, stateful flows, and product-grade UI behavior.",
  ...
  },
  {
    ...
    name: "JavaScript",
    group: "Core",
    description: "Interaction logic, DOM behavior, animation timing, and browser-side product details.",
  ...
  },
  {
    ...
    name: "TypeScript",
    group: "Core",
    description: "Safer frontend contracts and clearer implementation boundaries for growing products.",
    projects: ["demotion", "mywave"]
  },
  {
    id: "html",
    name: "HTML",
    group: "Structure",
    description: "Semantic layout and accessible document structure for portfolio and service screens.",
    projects: ["mywave"]
  },
  {
    id: "css",
    name: "CSS",
    group: "Motion UI",
    description: "Responsive layouts, layered visual systems, glow states, and motion-friendly surfaces.",
  ...
  },
  {
    ...
    name: "Tailwind CSS",
    group: "Styling",
    description: "Utility-first styling patterns and fast iteration for product interfaces.",
    projects: ["mywave"]
  },
  {
    id: "three",
    name: "Three.js",
    group: "3D",
    description: "Web 3D foundations for interactive scenes, depth, particles, and spatial UI concepts.",
  ...
  },
  {
    ...
    name: "GSAP",
    group: "Motion",
    description: "Timeline thinking for scroll-driven reveals, energy flow, and scene transitions.",
    projects: ["demotion"]
  },
  {
    id: "framer",
    name: "Framer Motion",
    group: "Motion",
    description: "Interaction states, hover feedback, and page transitions with product-level polish.",
    projects: ["demotion", "mywave"]
  },
  {
    id: "spring",
    name: "Spring Boot",
    group: "Backend",
    description: "API structure, service boundaries, and backend flows that support frontend products.",
    projects: ["demotion"]
  },
  {
    id: "unity",
    name: "Unity",
    group: "XR / Game",
    description: "Game UI implementation, interaction planning, and XR prototype thinking.",
  ...
  },
  {
    ...
    name: "GitHub",
    group: "Workflow",
    description: "Version control, collaboration flow, and project delivery hygiene.",
...
const projects = [
  {
    ...
    oneLine: "Interactive SaaS demos with behavior analytics for product-led sales.",
  ...
  },
  {
    ...
    oneLine: "A personal finance web app for shaping investment and spending flows.",
  ...
  },
  {
    ...
    oneLine: "A 폐병원 VR horror game where a special camera reveals hidden enemies, paths, and clues.",
  ...
  },
  {
    ...
    oneLine: "AR Plane Tracking, Tap Spawn, and UI interaction practice with Unity AR Foundation.",
    ...
    <header className="tree-header">
      ...
      <nav aria-label="Portfolio sections">
        {nav.map(function renderNav(item) {
          return (
            <a className={activeSection === item[0] ? "is-active" : ""} href={"#" + item[0]} key={item[0]}>
              {item[1]}
            </a>
          );
        })}
  ...
  useEffect(function bindCursor() {
    ...
    function addPulse(event) {
      ...
      setPulses(function add(current) {
        return current.concat([{id: id, x: event.clientX, y: event.clientY}]).slice(-5);
      });
  ...
  return (
    <div className="tree-cursor-layer" aria-hidden="true">
      ...
      {pulses.map(function renderPulse(pulse) {
        return <i key={pulse.id} style={{"--pulse-x": pulse.x + "px", "--pulse-y": pulse.y + "px"}} />;
      })}
    </div>
  );
}
  ...
  return (
    <div className="energy-tree" aria-hidden="true">
      <svg viewBox="0 0 900 760" role="img">
        ...
        <path className="tree-root-path" d="M448 716 C410 648 424 566 448 492 C478 402 478 310 448 218" />
        <path className="tree-branch branch-a" d="M450 460 C340 428 252 360 178 266" />
        <path className="tree-branch branch-b" d="M462 418 C562 386 656 314 736 214" />
        <path className="tree-branch branch-c" d="M448 348 C382 302 348 248 330 164" />
        <path className="tree-branch branch-d" d="M462 316 C520 254 578 178 610 88" />
        <path className="tree-energy-flow" d="M448 716 C410 648 424 566 448 492 C478 402 478 310 448 218 C520 254 578 178 610 88" />
        <path className="tree-energy-flow flow-alt" d="M448 492 C340 428 252 360 178 266" />
        <path className="tree-energy-flow flow-alt-two" d="M462 418 C562 386 656 314 736 214" />
        <g className="tree-leaf-cluster">
          {[0, 1, 2, 3, 4, 5, 6, 7, 8].map(function renderLeaf(index) {
            return <circle cx={180 + index * 68} cy={190 + (index % 3) * 52} key={index} r={9 + (index % 4)} />;
          })}
        </g>
      </svg>
      <div className="tree-energy-status">
        <span>{activeSkill ? "Skill energy linked" : activeProjectId ? "Project core opened" : "Root energy stable"}</span>
      </div>
    </div>
  );
}
    ...
    <section className="living-section tree-hero" data-section="hero" id="hero">
      <div className="tree-hero__copy">
        ...
        <div className="tree-actions">
          <a className="tree-button" href="#projects" onMouseEnter={onActivatePulse}>
            Explore fruits
          </a>
          <a className="tree-button is-secondary" href="#skills" onMouseEnter={onActivatePulse}>
            View branches
          </a>
        </div>
      </div>
...
function SkillKeyboard(props) {
  ...
  return (
    <section className="living-section skill-section" data-section="skills" id="skills">
      <div className="section-copy">
        <span className="tree-eyebrow">Branches / Leaves</span>
        <h2>Skills grow as connected branches.</h2>
        <p>Each branch keeps a practical skill connected to the products it helped shape.</p>
      </div>
      <div className="skill-layout">
        <div className="skill-keyboard" role="list" aria-label="Interactive skill keyboard">
...
function Projects(props) {
  ...
  return (
    <section className="living-section project-section" data-section="projects" id="projects">
      <div className="section-copy">
        <span className="tree-eyebrow">Fruits / Energy Cores</span>
        <h2>Projects are fruits grown from the same root system.</h2>
        <p>Each core holds a product story, implementation role, and what the work taught me.</p>
      </div>
        ...
        {projects.map(function renderProject(project, index) {
          const linked = activeSkill
            ? (skills.find(function findSkill(skill) {
                return skill.id === activeSkill;
              }) || {projects: []}).projects.indexOf(project.id) >= 0
            : false;
...
function ProjectDetail(props) {
  ...
  return (
    <div className="project-portal" role="dialog" aria-modal="true" aria-labelledby="project-portal-title">
      <button className="project-portal__backdrop" type="button" aria-label="Close project detail" onClick={onClose} />
      <article className="project-portal__panel" style={{"--portal-accent": project.accent}}>
        <header>
          <div>
          ...
          <button className="portal-close" type="button" aria-label="Close project detail" onClick={onClose}>
            Close
          </button>
        </header>
        ...
        <footer>
          {project.links.map(function renderLink(link) {
            return (
              <a href={link.href} key={link.label} rel="noreferrer" target={link.href === "#" ? undefined : "_blank"}>
                {link.label}
              </a>
            );
          })}
...
function GrowthTimeline() {
  return (
    <section className="living-section growth-section" data-section="growth" id="growth">
      <div className="section-copy">
...
function Contact() {
  ...
  return (
    <section className="living-section contact-section" data-section="contact" id="contact">
      ...
      <div className="section-copy">
        ...
        <p>Portfolio ends here, but the next product can start from this seed.</p>
      </div>
...
function Credits() {
  return (
    <footer className="tree-credits">
      <span>
        Interaction structure inspired by Jayant Potdar&apos;s MIT licensed 3D Portfolio. Reimagined as a custom Living Tree
        portfolio with original content and styling.
      </span>
    </footer>
  );
}
...
function LivingTreePortfolio() {
  ...
  useEffect(function observeSections() {
    const nodes = Array.prototype.slice.call(document.querySelectorAll("[data-section]"));
  ...
  return (
    <main className="living-tree-portfolio">
      ...
      <EnergyTree activeProjectId={treeStatus.activeProjectId} activeSkill={treeStatus.activeSkill} pulse={treeStatus.pulse} />
      <Hero onActivatePulse={triggerPulse} />
      <SkillKeyboard activeSkill={activeSkill} onSelectSkill={setActiveSkill} relatedProjectIds={relatedProjectIds} />
