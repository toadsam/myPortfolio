...
| 프로젝트 | 방 폴더 | 상태 |
|---|---|---|
| `09 darklab` | `project-viewers/darklab/` | ✅ 12섹션 |
| `05 aclub` | `project-viewers/aclub/` | ✅ |
| `07 sign-language` | `project-viewers/sueo/` | ✅ 11섹션 전부 (PAGE 04는 교체된 스펙 기준으로 재작성 완료) |
| 나머지 | — | 미착수 (카테고리 뷰어로 렌더 중) |

> 🔧 **구현 방법·함정·검증 절차는 `_IMPLEMENTATION.md`.**
> 새 세션에서 Variant HTML을 코드로 옮길 때는 그 파일 하나만 읽으면 된다.
